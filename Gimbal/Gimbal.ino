...
MPU6050 mpu;
Servo servo0; // Yaw (Pin 10)
Servo servo1; // Pitch (Pin 9)
Servo servo2; // Roll (Pin 8)
...
// Pitch PID (Servo 1, Pin 9)
float pitchKp = 1.2; // Proportional gain
float pitchKi = 0.0; // Integral gain
float pitchKd = 0.04; // Derivative gain

// Roll PID (Servo 2, Pin 8)
float rollKp = 1.2; // Proportional gain
float rollKi = 0.0; // Integral gain
float rollKd = 0.04; // Derivative gain
